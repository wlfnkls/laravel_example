                    ...
                    @if (Auth::user()->role_id == '1')
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        class="flex items-center text-sm font-medium text-white hover:text-gray-500 focus:outline-none transition duration-150 ease-in-out">
                                        <div>Companies</div>
                                ...
                                <x-slot name="content">
                                    <x-dropdown-link :href="route('companies')"
                                        :active="request()->routeIs('companies')">
                                        {{ __('Show Companies') }}
                                    </x-dropdown-link>
                                    <x-dropdown-link :href="route('company')" :active="request()->routeIs('company')">
                                        {{ __('Register Company') }}
                                    </x-dropdown-link>
                                </x-slot>
                            </x-dropdown>
